...
export const HEX = {
  ...
  // M4-T2 (SPEC_M4 §2): reveal이 꺼졌을 때 모든 사건 점이 쓰는 "조직 무관" 중립색. ink-dim(#8CA0B3)
  // 이나 hair-lit(#57708A)을 재사용하지 않고 별도 값을 둔 이유 — 저 둘은 이미 "본문 텍스트"와
  // "인터랙티브 강조 테두리"라는 다른 의미를 지고 있어서, 사건 점에도 같이 쓰면 그 의미가 섞인다.
  // nw/tb/ds(조직 식별색)와는 확실히 구분되면서도 accent(cyan 단독)를 침범하지 않는 중간 톤.
  evt: "#6C8598",
};
